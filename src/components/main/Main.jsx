        ...
        <div className="item-contaner">
          <div className="left content-item">
            ...
            <div className="para">
              ...
              meaningful technology designs and purposeful development work.
              their mission is to empower young people to craft fulfilling work
        ...
        <div className="item-contaner right-item">
          <div className="right content-item">
            ...
            <div className="para">
              ...
              500, UNITING TO FORGE THE ULTIMATE ON-CHAIN U.A.C (ULTIMATE ACCESS
              CARD) FOR EVERY ASPIRING SOUL.
            </div>
          </div>
        </div>
        <div className="item-contaner">
